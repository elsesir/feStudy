/**
 * Created by bigWhite on 18/2/5.
 */
window.onload=function() {
    var ball1 = document.getElementById("ball1"),
        ballcxt = ball1.getContext("2d");
    ballcxt.beginPath();
    ballcxt.arc(500,250,150,0, 2* Math.PI, false);
    ballcxt.lineWidth = 2;
    ballcxt.strockStyle = "#ffffff";
    ballcxt.stroke();
    ballcxt.closePath();

    ballcxt.beginPath();
    ballcxt.arc(500,250,100,0, 2* Math.PI, false);
    ballcxt.lineWidth = 2;
    ballcxt.strockStyle = "#ffffff";
    ballcxt.stroke();
    ballcxt.closePath();
    ...
    ballcxt.beginPath();
    ballcxt.arc(500,250,50,0, 2* Math.PI, false);
    ballcxt.lineWidth = 2;
    ballcxt.strockStyle = "#ffffff";
    ballcxt.stroke();
    ballcxt.closePath();
